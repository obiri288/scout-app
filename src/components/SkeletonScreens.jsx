...
export const FeedSkeleton = () => (
    <div className="max-w-md mx-auto space-y-6 pt-4">
        {[1, 2, 3].map(i => (
            <div key={i} className="bg-card border-b border-border pb-6">
                {/* Header */}
...
export const ProfileSkeleton = () => (
    <div className="animate-in fade-in">
        <div className="relative bg-card pb-6 rounded-b-[2rem] overflow-hidden">
            <div className="absolute inset-0 h-40 bg-gradient-to-br from-indigo-900/20 via-slate-900/10 to-background" />
            <div className="flex flex-col items-center pt-16 relative z-10 px-6">
                ...
                {/* Club */}
                <div className="h-4 bg-muted/60 rounded w-28 animate-pulse mb-4" />
                {/* Status pill */}
                <div className="h-6 bg-muted/40 rounded-full w-24 animate-pulse mb-6" />
                {/* Stats grid */}
                <div className="grid grid-cols-3 gap-3 w-full mb-6">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="bg-white/5 border border-border rounded-2xl p-4 flex flex-col items-center">
                            <div className="h-5 w-8 bg-muted rounded animate-pulse mb-2" />
...
export const SearchSkeleton = () => (
    <div className="space-y-3 pt-4">
        {[1, 2, 3, 4, 5].map(i => (
            <div key={i} className="flex items-center gap-4 p-3 bg-card rounded-2xl border border-border">
                <div className="w-14 h-14 rounded-2xl bg-muted animate-pulse" />
                <div className="flex-1 space-y-2">
                    <div className="h-4 bg-muted rounded w-28 animate-pulse" />
                    <div className="h-3 bg-muted/60 rounded w-20 animate-pulse" />
                </div>
