            ...
            {isOpen && (
                <>
                    ...
                    <motion.div 
                        ...
                        className="fixed top-0 left-0 bottom-0 w-[280px] bg-card border-r border-border z-[10002] flex flex-col shadow-2xl"
                    >
                        {/* Header */}
                            ...
                            {categories.map(category => {
                                ...
                                return (
                                    <div key={category} className="space-y-2">
                                        <h3 className="px-3 text-[10px] font-black text-muted-foreground/60 uppercase tracking-[0.2em] mb-4">{category}</h3>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className={`transition-transform duration-300 ${isActive ? 'scale-110' : 'group-hover:scale-110'}`}>
                                                            <item.icon size={20} className={isActive ? 'text-cyan-400' : 'text-muted-foreground/60 group-hover:text-foreground'} />
                                                        </div>
                                                        <span className={`text-[15px] font-bold tracking-tight ${isActive ? 'text-cyan-400' : 'text-muted-foreground group-hover:text-foreground'}`}>
                                                            {item.label}
                                                        </span>
                                                        {isActive && (
                                                            <motion.div 
