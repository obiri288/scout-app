        ...
        >
            {Icon && (
                <motion.div
                    ...
                    className="mb-5"
                >
                    <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-emerald-500/15 to-emerald-600/5 border border-emerald-500/10 flex items-center justify-center shadow-lg shadow-emerald-500/5">
                        <Icon size={36} className="text-emerald-400/60" />
                    </div>
                </motion.div>
            )}
            <motion.h3
            ...
            {actionLabel && onAction && (
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onAction}
                    className="bg-gradient-to-r from-emerald-600 to-emerald-500 text-white font-bold text-sm px-6 py-2.5 rounded-xl shadow-lg shadow-emerald-900/30 border border-emerald-400/20 transition-all"
                >
                    {actionLabel}
                </motion.button>
            )}
