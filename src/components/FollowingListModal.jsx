...
export const FollowingListModalContent = ({ userId, onClose, onUserClick }) => {
            ...
            <div className={`w-full max-w-md ${cardStyle} h-[70vh] p-4 flex flex-col`}>
                <div className="flex justify-between items-center mb-4 pb-2 border-b border-border">
                    <h2 className="font-bold text-foreground flex items-center gap-2">
                        <Users size={18} className="text-blue-500" /> Folgt
                    </h2>
                ...
                <div className="flex-1 space-y-2 overflow-y-auto max-h-[calc(70vh-60px)]">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-16 gap-3">
                            ...
                            <span className="text-xs text-muted-foreground font-medium">Lade Liste...</span>
                        </div>
                    ) : (following || []).length === 0 ? (
                        <EmptyState 
                            icon={Users} 
...
export const FollowingListModal = (props) => (
    <SafeErrorBoundary>
        <FollowingListModalContent {...props} />
    </SafeErrorBoundary>
);
